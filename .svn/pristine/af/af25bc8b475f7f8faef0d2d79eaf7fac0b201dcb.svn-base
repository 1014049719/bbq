...
typedef NS_ENUM(NSUInteger, BBQHTTPRequestType){
     ...
     *  删除宝宝
     */
    BBQHTTPRequestTypedeletebaobao,
    /**
     *  删除和宝宝的关系
     */
     ...
     *  取消班级关注
     */
    BBQHTTPRequestTypecancelattentionclass,
    /**
     * 启动广告页面
     */
     ...
     *  获取广场动态栏目
     */
    BBQHTTPRequestTypeSquare,
    /**
     *  获取同班宝宝列表
     */
    BBQHTTPRequestTypeclassbaobao,
    /**
     *  获取输入号码的家长的宝宝列表
     */
    BBQHTTPRequestTypebaobaolistbynum,
    /**
     *  关注宝宝
     */
    BBQHTTPRequestTypeattentionbaobao,
    /**
     *  取消关注宝宝
     */
    BBQHTTPRequestTypecancelattentionbaobao,
    /**
     *  获取申请列表记录及申请关注我的宝宝记录数接口
     */
    BBQHTTPRequestTypeattentionList,
    /**
     *  关注同意或者拒绝接口
     */
    BBQHTTPRequestTypeattentionManager,
    /**
     *  通过老师手机号码关注班级
     */
    BBQHTTPRequestTypeBabyIntoClassByPhone,
    /**
     *  输入学校关键字查询同名学校列表接口
     */
    BBQHTTPRequestTypeSearchInput,
};
