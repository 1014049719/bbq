...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _backgroundColors[@(FSCalendarCellStateDisabled)]    = [UIColor lightGrayColor];
        ...
        _titleColors[@(FSCalendarCellStateNormal)]      = [self colorWithHex:@"999999"];
        _titleColors[@(FSCalendarCellStateSelected)]    = [UIColor whiteColor];
        _titleColors[@(FSCalendarCellStateDisabled)]    = [UIColor blackColor];
