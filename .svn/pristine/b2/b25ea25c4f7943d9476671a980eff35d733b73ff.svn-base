...
//    if (self) {
//        self.backgroundColor = [UIColor colorWithHexStringString:@"0xf8f8f8"];
//
//        _recordTipsLabel = [[UILabel alloc] init];
//        _recordTipsLabel.font = [UIFont systemFontOfSize:18];
//        [self addSubview:_recordTipsLabel];
//
//        _volumeLeftView = [[AudioVolumeView alloc] initWithFrame:CGRectMake(0,
//        0, kAudioVolumeViewWidth, kAudioVolumeViewHeight)];
//        _volumeLeftView.type = AudioVolumeViewTypeLeft;
//        _volumeLeftView.hidden = YES;
//        [self addSubview:_volumeLeftView];
//
//        _volumeRightView = [[AudioVolumeView alloc]
//        initWithFrame:CGRectMake(0, 0, kAudioVolumeViewWidth,
//        kAudioVolumeViewHeight)];
//        _volumeRightView.type = AudioVolumeViewTypeRight;
//        _volumeRightView.hidden = YES;
//        [self addSubview:_volumeRightView];
//
//        _recordView = [[AudioRecordView alloc]
//        initWithFrame:CGRectMake((self.frame.size.width - 86) / 2, 62, 86,
//        86)];
...
//        [tipLabel sizeToFit];
//        tipLabel.center = CGPointMake(self.frame.size.width/2,
...
//                _recordTipsLabel.textColor = [UIColor
//                colorWithRGBHex:0x2faeea];
//            }
//            else {
//                _recordTipsLabel.textColor = [UIColor
//                colorWithRGBHex:0xDE4743];
//            }
...
//        _volumeLeftView.center = CGPointMake(_recordTipsLabel.frame.origin.x -
//        _volumeLeftView.frame.size.width/2 - 12, _recordTipsLabel.center.y);
//        _volumeLeftView.hidden = NO;
//        _volumeRightView.center = CGPointMake(_recordTipsLabel.frame.origin.x
//        + _recordTipsLabel.frame.size.width +
//        _volumeRightView.frame.size.width/2 + 12, _recordTipsLabel.center.y);
...
//    selector:@selector(increaseRecordTime) userInfo:nil repeats:YES];
//}
//
//- (void)stopTimer {
//    if (_timer) {
...
//    return [NSString stringWithFormat:@"%02d:%02d", duration / 60, duration %
//    60];
//}
//
...
//}
//
//- (void)recordViewRecordFinished:(AudioRecordView *)recordView file:(NSString
//*)file duration:(NSTimeInterval)duration {
//    [self stopTimer];
//    if (self.state == UIMessageInputView_VoiceStateRecording) {
...
//}
//
//- (void)recordView:(AudioRecordView *)recordView
//touchStateChanged:(AudioRecordViewTouchState)touchState {
