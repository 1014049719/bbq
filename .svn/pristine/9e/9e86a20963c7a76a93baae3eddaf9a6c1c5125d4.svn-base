...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [[BBQPublishManager sharedManager] bk_addObserverForKeyPath:@"working" options:NSKeyValueObservingOptionNew | NSKeyValueObservingOptionInitial task:^(id obj, NSDictionary *change) {
