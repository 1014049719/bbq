...
- (void)setIftttRotationTransform:(NSValue *)iftttRotationTransform {
  objc_setAssociatedObject(self, @selector(iftttRotationTransform),
                           iftttRotationTransform,
...
- (void)setIftttScaleTransform:(NSValue *)iftttScaleTransform {
  objc_setAssociatedObject(self, @selector(iftttScaleTransform),
                           iftttScaleTransform,
                           OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
...
- (void)setIftttTranslationTransform:(NSValue *)iftttTranslationTransform {
  objc_setAssociatedObject(self, @selector(iftttTranslationTransform),
                           iftttTranslationTransform,
                           OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
