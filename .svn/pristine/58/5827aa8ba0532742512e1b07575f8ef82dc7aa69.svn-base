  ...
  if (toDisk) {
    dispatch_async(self.ioQueue, ^{
      ...
      if (image && (recalculate || !data)) {
        ...
        // If the imageData is nil (i.e. if trying to save a UIImage directly or
        // the image was transformed on download)
        // and the image has an alpha channel, we will consider it PNG to avoid
