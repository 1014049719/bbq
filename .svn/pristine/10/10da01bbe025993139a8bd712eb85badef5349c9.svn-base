 ...
 */
typedef void (^ReturnMenuButtomFrameBlock)(CGRect rect,BOOL isShow);
...
/**
 回调Block 返回菜单MenuButton的Frame
 */
@property (nonatomic, copy) ReturnMenuButtomFrameBlock returnFrameBlock;
