...
//默认时候普通字体颜色
#define  kNomalColor [UIColor colorWithHexString:@"999999"]
//默认时候选中字体颜色
#define kSelectedColor  [UIColor colorWithHexString:@"ff6440"]
//涌入效果的字体颜色
...
static CGFloat const kDotWidth = 6.0;

#define kNormalSize 14
#define BtnGap 10
#define MenuHeight 34
