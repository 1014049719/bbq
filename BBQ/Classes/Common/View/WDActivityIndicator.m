...
- (id)initWithFrame:(CGRect)frame {
  CGRect fixedFrame = {frame.origin, {24, 24}};
...
- (void)setIndicatorStyle:(WDActivityIndicatorStyle)indicatorStyle {
  ...
  NSMutableString *imageName =
      [NSMutableString stringWithString:@"WDActivityIndicator.bundle/"];
...
- (void)setNativeIndicatorStyle:
    (UIActivityIndicatorViewStyle)nativeIndicatorStyle {
