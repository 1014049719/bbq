...
//        [_deleteBtn setImage:[UIImage imageNamed:@"btn_delete_tweetimage"]
...
//        dispatch_queue_create("UIMessageInputView_CCellForAsset",
//        DISPATCH_QUEUE_SERIAL);
//        dispatch_async(queue, ^{
//            [assetsLibrary assetForURL:_media.assetURL resultBlock:^(ALAsset
//            *asset) {
...
//        } else {
//            [self.imgView sd_setImageWithURL:[_media.urlStr
//            urlImageWithCodePathResizeToView:self.contentView]
//            placeholderImage:kPlaceholderCodingSquareWidth(55.0)
