...
//  Copyright (c) 2015年 Modern Mobile Digital Media Company Limited. All rights
//  reserved.
//
...
NSString *const SlateReachabilityDidChangeNotification =
    @"slatecore.networking.reachability.change";
...
- (void)reachabilityChanged:(NSNotification *)note {
  [[NSNotificationCenter defaultCenter]
      postNotificationName:SlateReachabilityDidChangeNotification
                    object:nil];
}
...
- (BOOL)isNetworkBroken {
  if (self.reachabilityManager.networkReachabilityStatus ==
