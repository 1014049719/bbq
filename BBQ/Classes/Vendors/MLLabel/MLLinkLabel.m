...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    if (self.activeLink) {
        ...
        if (self.delegate && [self.delegate respondsToSelector:@selector(didClickNonLinkAreaInLinkLabel:)]) {
...
- (void)longPressGestureDidFire:(UILongPressGestureRecognizer *)sender {
    if (sender.state==UIGestureRecognizerStateBegan) {
        if (self.delegate && [self.delegate respondsToSelector:@selector(didLongPressNonLinkAreaInLinkLabel:)]) {
