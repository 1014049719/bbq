...
+ (void)searchSyncOrderBy:(NSString *)orderBy count:(int)count results:(JJFMDBResults)block;
/**
 *  返回所有的数据
 *
...
//+ (void)searchSyncOrderBy:(NSString *)orderBy pageNum:(int)pageNum results:(JJFMDBResults)block;
...
//+ (void)searchSyncWhere:(NSString *)where pageNum:(int)pageNum results:(JJFMDBResults)block;
/**
 *  返回count条数据
 *
 *  @param where   where条件,自定义,例where:@"rowid = 2"或者@"string = 'Jay'"
...
//+ (void)searchSyncWhere:(NSString *)where orderBy:(NSString *)orderBy pageNum:(int)pageNum results:(JJFMDBResults)block;
...
+ (void)searchSyncWhereDic:(NSDictionary *)whereDic pageNum:(int)pageNum results:(JJFMDBResults)block;
...
//- (void)insertToSyncDB:(JJFMDBSuccess)block;
/**
...
- (void)updateSyncToDB:(NSString *)where result:(JJFMDBSuccess)block;
...
+ (void)updateSyncToDB:(NSString *)updateKey where:(NSString *)where result:(JJFMDBSuccess)block;
...
- (void)updateSyncToDBDic:(NSDictionary *)whereDic result:(JJFMDBSuccess)block;
/**
 *  更新model,自定义whereDic
 *
 *  @param UpdateKeyDic Update的数据,例:@{@"height":@1.8, @"weight":@60}
...
+ (void)updateSyncToDBDic:(NSDictionary *)updateKeyDic whereDic:(NSDictionary *)whereDic result:(JJFMDBSuccess)block;
