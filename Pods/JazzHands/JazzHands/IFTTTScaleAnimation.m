...
- (void)animate:(CGFloat)time {
  ...
  self.view.iftttScaleTransform =
      [NSValue valueWithCGAffineTransform:scaleTransform];
  ...
  if (self.view.iftttTranslationTransform) {
    newTransform = CGAffineTransformConcat(
        newTransform,
        [self.view.iftttTranslationTransform CGAffineTransformValue]);
  }
