...
CG_INLINE CGFLOAT_TYPE
IFTTTJazzHandsPow(CGFLOAT_TYPE aFloat, CGFLOAT_TYPE aPower) {
...
IFTTTEasingFunction const IFTTTEasingFunctionEaseInBounce =
    ^CGFloat(CGFloat t) {
...
IFTTTEasingFunction const IFTTTEasingFunctionEaseOutBounce =
    ^CGFloat(CGFloat t) {
      ...
      if (t < 8.f / 11.f) {
        return 3.0 / 4.0 +
               IFTTTJazzHandsPow(11.f / 4.f, 2) *
                   IFTTTJazzHandsPow(t - 6.f / 11.f, 2);
      }

      if (t < 10.f / 11.0f) {
        return 15.f / 16.f +
               IFTTTJazzHandsPow(11.f / 4.f, 2) *
                   IFTTTJazzHandsPow(t - 9.f / 11.f, 2);
      }

      return 63.f / 64.f +
             IFTTTJazzHandsPow(11.f / 4.f, 2) *
                 IFTTTJazzHandsPow(t - 21.f / 22.f, 2);
    };
