...
+ (instancetype) return:(id)value {
  return [[self sequenceWithArray:@[ value ] offset:0]
...
- (instancetype)bind:(RACStreamBindBlock (^)(void))block {
  ...
  NSMutableArray *resultArray =
      [NSMutableArray arrayWithCapacity:currentArray.count];
  ...
  return [[self.class sequenceWithArray:resultArray offset:0]
